...
natural arredondarmos a amplitude para 4.
...
Nesse exemplo, vamos usar intervalos do tipo
`[a, b)`, pois o primeiro valor de quebra de classe é o igual ao valor mínimo do conjunto de dados, e dessa forma garantimos que todos os valores pertençam a alguma das classes.
...
1. Em um questionário aplicado aos estudantes que frequentavam a livraria
   do campus, foi perguntado como classificariam o serviço prestado. As
   respostas foram:
```{r}
ex <- c("ótimo", "bom", "bom", "péssimo", "bom", "bom", "ótimo",
  "ótimo", "bom", "ótimo", "bom", "ótimo", "bom", "bom", "ótimo", "bom",
  "péssimo", "bom", "péssimo", "bom", "péssimo", "bom", "bom", "bom",
  "bom", "ótimo", "bom", "péssimo", "ótimo", "ótimo", "bom", "péssimo")
ex
```
...
sort(ex1)
```
a. Monte uma tabela construindo as classes conforme os critérios apresentados
