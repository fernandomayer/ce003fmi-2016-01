...
<<pacotes, echo=FALSE, warning=FALSE, message=FALSE>>=
...
\begin{frame}[fragile]{Testes de hipótese para a média: $\sigma$ conhecido}
  ...
  \pause
<<echo=FALSE>>=
teste.hip.z(alfa = 0.05, xbarra = 698, mu0 = 700, sigma = 10, n = 40,
            alt = "b")
@
\end{frame}
...
\begin{frame}[fragile]{Testes de hipótese para a média: $\sigma$ conhecido}
  ...
  \pause
<<echo=FALSE>>=
teste.hip.z(alfa = 0.10, xbarra = 210, mu0 = 206, sigma = 12, n = 30,
            alt = "d")
@
\end{frame}
...
\begin{frame}[fragile]{Testes de hipótese para a média: $\sigma$ desconhecido}
  ...
  \pause
<<echo=FALSE>>=
teste.hip.t(alfa = 0.01, xbarra = 1070, mu0 = 1120, dp = 125, n = 8,
            alt = "b")
@
\end{frame}
...
\begin{frame}[fragile]{Testes de hipótese para a média: $\sigma$ desconhecido}
  ...
  \pause
<<echo=FALSE>>=
teste.hip.t(alfa = 0.05, xbarra = 38, mu0 = 40, dp = sqrt(0.25), n = 25,
            alt = "e")
@
\end{frame}
...
\begin{frame}[fragile]{Testes de hipótese para a média: $\sigma$ desconhecido}
  ...
  \pause
<<echo=FALSE>>=
teste.hip.t(alfa = 0.10, xbarra = 1.004, mu0 = 1, dp = 0.003, n = 10,
            alt = "d")
@
\end{frame}
